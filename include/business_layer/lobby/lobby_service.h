...
public:
    LobbyService(ISafetyService& safetyService, ICommandService& commandService, IDeviceService&  deviceService,ITimer& timer, DeviceStatusCache& deviceStatusCache);/*  IDeviceService& deviceService,IDetectionService& detectionService */
